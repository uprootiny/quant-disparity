#!/usr/bin/env python3
"""
Exp-006: Pythia-160M scaling test
Goal: Third model validation of disparity pattern
"""
...
def main():
    start = datetime.now()
    print(f"[{start.strftime('%H:%M:%S')}] Exp-006: Pythia-160M")
    print("=" * 40)
    ...
    print(f"  OPT-125M (125M):   153.32x")
    print(f"  Pythia-160M (160M): {disparity:.2f}x")
    ...
    result = {
        ...
        "cross_model": {
            "gpt2": 213.82,
            "opt125m": 153.32,
            "pythia160m": disparity,
        },
        "status": "SUCCESS"
    }

    out_file = Path(__file__).parent / "exp006_result.json"
